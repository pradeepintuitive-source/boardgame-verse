...
export function TradePanel({ state, meId, partnerId, existingOffer, onClose, onPropose, onAccept, onDecline }: Props) {
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <section>
            ...
            <PropPicker state={state} playerId={meId} selected={myProps} onToggle={toggle(setMyProps, myProps)} />
          ...
          <section>
            ...
            <PropPicker state={state} playerId={partnerId} selected={theirProps} onToggle={toggle(setTheirProps, theirProps)} />
            <label className="block mt-3 text-[10px] font-mono uppercase">Cash ($)</label>
            <input
              type="number"
              min={0}
        ...
        <div className="flex gap-2 mt-6 justify-end">
          {isReview ? (
            <>
              <NeonButton variant="ghost" size="sm" onClick={onDecline}>Decline</NeonButton>
              <NeonButton variant="cyan" size="sm" onClick={onAccept}>Accept</NeonButton>
            </>
          ) : (
            <NeonButton
              variant="cyan"
