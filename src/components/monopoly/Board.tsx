 ...
 */
function gridPosition(index: number): { row: number; col: number; orientation: "top" | "right" | "bottom" | "left" | "corner" } {
      ...
      >
        ...
        >
          <div className="text-center">
            <div className="font-display text-5xl md:text-7xl italic uppercase neon-text-glow">MONOPOLY</div>
            <div className="text-[10px] font-mono uppercase tracking-[0.4em] text-accent-cyan mt-2">GameHub Edition</div>
          </div>
        </div>
      </div>
    </div>
