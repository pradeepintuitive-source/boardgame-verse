...
export function ActionBar({ state, me, isMyTurn, onRoll, onBuy, onAuction, onEnd, onPayJail, onJailCard }: Props) {
    ...
    <div className="glass-panel border border-accent-cyan/30 p-4 flex flex-col gap-3">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="font-bold" style={{ color: cur.avatarColor }}>{cur.username}</div>
        </div>
