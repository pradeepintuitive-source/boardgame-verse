      ...
      {!hideChrome && (
        <nav className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-6 md:px-10 py-5">
          ...
          <div className="hidden md:flex gap-8 text-[11px] font-mono tracking-widest text-foreground/40">
            <Link to="/" activeOptions={{ exact: true }} className="hover:text-accent-cyan transition-colors" activeProps={{ className: "text-accent-cyan" }}>HOME</Link>
            <Link to="/profile" className="hover:text-accent-cyan transition-colors" activeProps={{ className: "text-accent-cyan" }}>PROFILE</Link>
            <Link to="/settings" className="hover:text-accent-cyan transition-colors" activeProps={{ className: "text-accent-cyan" }}>SETTINGS</Link>
          </div>
