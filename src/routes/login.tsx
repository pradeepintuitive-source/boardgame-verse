      ...
      <div className="min-h-screen grid place-items-center px-6 pt-32 pb-20">
        <form onSubmit={submit} className="w-full max-w-md glass-panel p-8">
          ...
          <label className="block mb-4">
            <span className="text-[10px] font-mono uppercase tracking-widest text-white/40">Username</span>
            <input
              value={username}
          ...
          <label className="block mb-8">
            <span className="text-[10px] font-mono uppercase tracking-widest text-white/40">Password</span>
            <input
              type="password"
              value={password}
