...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Play Mafia and Monopoly with friends or AI. Single-device, LAN, or online — premium board gaming for the modern arcade." },
      { property: "og:title", content: "GameHub — Premium Multiplayer Board Gaming" },
      { property: "og:description", content: "Mafia & Monopoly. Single-device, LAN, online. Premium board gaming reborn." },
    ],
  }),
  component: Index,
});
      ...
      <main className="relative flex flex-col items-center pt-32 pb-32 px-6">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link to="/join-room">
              <NeonButton variant="ghost" size="lg">Join Game</NeonButton>
            </Link>
          </div>
        </motion.section>
