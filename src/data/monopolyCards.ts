...
export const CHANCE_CARDS: DeckCard[] = [
  ...
  { text: "Advance to St. Charles Place.", action: { kind: "move", to: 11, collectGoIfPass: true } },
  ...
  { text: "Take a trip to Reading Railroad.", action: { kind: "move", to: 5, collectGoIfPass: true } },
  { text: "Elected Chairman — pay each player $50.", action: { kind: "moneyFromEach", amount: -50 } },
...
export const CHEST_CARDS: DeckCard[] = [
  ...
  { text: "It's your birthday — collect $10 from each player.", action: { kind: "moneyFromEach", amount: 10 } },
  ...
  { text: "You won second prize in a beauty contest. Collect $10.", action: { kind: "money", amount: 10 } },
];