...
* **Topic Destination**: `/topic/games/{gameId}`
* **Payload**: Full game state engine snapshots.
* **Triggers**: Reconciles the client-side board.
...
* **Destination**: `/app/games/{gameId}/auction`
* **Payload**:
```json
{
  "amount": 250
